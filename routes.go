...
type RouteSummary struct {
	...
	Distance            float64         `json:"distance"`              // The route's distance, in meters
	ElevationGain       float64         `json:"elevation_gain"`        // The route's elevation gain.
